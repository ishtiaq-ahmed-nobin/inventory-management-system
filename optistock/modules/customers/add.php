...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        log_activity($pdo, $_SESSION['user_id'], "Added customer: $name", 'customers');
...
<div class="d-flex justify-content-between align-items-center mb-4">
  <h5 class="mb-0"><span class="material-icons align-middle mr-2">person_add</span>Add Customer</h5>
